...
export const options = {
  ...
  thresholds: {
    // 提高阈值标准 - 当前性能远超原阈值，设置更严格的标准
    http_req_duration: ['p(95)<10', 'p(99)<20'],  // 10ms/20ms（企业级标准）
    http_req_failed: ['rate<0.001'],              // 0.1% 失败率（高可靠性）
    job_submit_success: ['rate>0.99'],           // 99% 成功率
  },
